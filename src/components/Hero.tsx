        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col items-start text-center lg:text-left">
            ...
            >
              <a
                href="#publier"
                className="group relative inline-flex w-full items-center justify-center gap-2 rounded-xl bg-brand px-7 py-4 text-base font-semibold text-brand-foreground shadow-[0_10px_40px_-12px_hsl(var(--brand)/0.5)] [will-change:transform,box-shadow] [transform:translateZ(0)] [backface-visibility:hidden] transition-[background-color,box-shadow] duration-200 hover:bg-brand-hover focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand/30 motion-safe:[animation:cta-pop_0.55s_cubic-bezier(0.34,1.56,0.64,1)_0.42s_both,cta-bounce_2.2s_ease-in-out_1.1s_infinite] sm:w-auto"
              >
